...
| Printed AprilTags (10-inch black square) | 4 | tag36h11 IDs 582-585; use [print-ready files](../../apriltags/README.md) on 13 x 19 inch paper |
...
- Build and test the field before event day.
- Keep AprilTag IDs and placement consistent between fields.
- Tape fixed barriers securely so robots cannot move them.
- Foam pit cubes are intentionally sonar-invisible and should be treated as movable obstacles.
