...
def todo(label):
    raise NotImplementedError(f'{label}: fill in this TODO section')
...
class AprilTagNavigator:
    ...
    def __init__(self, config_path='config.yaml'):
        ...
        self.detector = todo('TODO 1')  # YOUR CODE HERE
    ...
    def open_camera(self):
        ...
        if self.camera is None or not self.camera.isOpened():
            ...
            self.camera = todo('TODO 2')  # YOUR CODE HERE
    ...
    def drive_mecanum(self, strafe, forward):
        ...
        fl = todo('TODO 4 fl')  # YOUR CODE HERE
        fr = todo('TODO 4 fr')  # YOUR CODE HERE
        rl = todo('TODO 4 rl')  # YOUR CODE HERE
        rr = todo('TODO 4 rr')  # YOUR CODE HERE
    ...
    def detect_tag(self, tag_id):
        ...
        ret, frame = todo('TODO 5 camera read')  # YOUR CODE HERE

        if not ret:
            return None

        # Hint: cv2.cvtColor(frame, cv2.COLOR_BGR2GRAY)
        gray = todo('TODO 5 grayscale')  # YOUR CODE HERE
        ...
        detections = todo('TODO 5 detect')  # YOUR CODE HERE
    ...
    def calculate_control(self, tag):
        ...
        x = todo('TODO 6 x')  # YOUR CODE HERE - lateral offset
        z = todo('TODO 6 z')  # YOUR CODE HERE - distance forward

        # TODO 7: Calculate errors
        # Hint: lateral_error = x (want to minimize x, so error = x - 0)
        #       distance_error = z - target_distance
        lateral_error = todo('TODO 7 lateral_error')  # YOUR CODE HERE
        distance_error = todo('TODO 7 distance_error')  # YOUR CODE HERE

        # TODO 8: Proportional control
        # Hint: speed = gain * error
        strafe_speed = todo('TODO 8 strafe_speed')  # YOUR CODE HERE (use self.kx)
        forward_speed = todo('TODO 8 forward_speed')  # YOUR CODE HERE (use self.kz)
    ...
    def navigate_to_tag(self, tag_id, timeout=30.0):
        ...
        try:
            while True:
                ...
                if todo('TODO 11 arrived'):  # YOUR CODE HERE
                    print("Timeout!")
                    return False
                ...
                if todo('TODO 10 timeout'):  # YOUR CODE HERE
                    print("Arrived!")
                    self.stop_motors()
                    return True
